...
AmountMenu WarpsOverridesMenu = {
    ...
    .initialCursorPos = 0,
    {
        ...
        },
        {
            ...
            .nDigits  = 1,
            .hex      = false,
            .title    = "ZoneoutType/RespawnFlag",
            .method   = Warps_SetRespawnFlag,
        },
    },
};
...
const WarpsPlacesMenuEntry placesMenuEntries[] = {
    { "Dungeons", &WarpsPlacesDungeonsMenu },   { "Bosses", &WarpsPlacesBossesMenu },
    { "Towns", &WarpsPlacesTownsMenu },         { "Houses", &WarpsPlacesHousesMenu },
    { "Shops", &WarpsPlacesShopsMenu },         { "Misc", &WarpsPlacesMiscMenu },
