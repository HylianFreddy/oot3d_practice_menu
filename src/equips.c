...
void Equips_ModifyGear(s32 selected) {
    ...
    if (selected == EQUIP_SWORD) {
        switch (EquipsMenu.items[EQUIP_SWORD].amount) {
            case (0):
                gSaveContext.equips.buttonItems[0] = 255;
                break;
            case (1):
                gSaveContext.equips.buttonItems[0] = 59;
                break;
            case (2):
                gSaveContext.equips.buttonItems[0] = 60;
                break;
            case (3):
                gSaveContext.equips.buttonItems[0] = 61;
                break;
        }
...
AmountMenu EquipsMenu = {
    ...
    .initialCursorPos = 0,
    {
        ...
        },
        {
            ...
            .nDigits  = 1,
            .hex      = false,
            .title    = "Sword (0-3) - Swordless Flag OFF",
            .method   = Equips_ModifyGear,
        },
        {
            .amount   = 0,
            .isSigned = false,
