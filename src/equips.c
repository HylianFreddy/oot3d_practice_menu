...
AmountMenu EquipsMenu = {
    ...
    .initialCursorPos = 0,
    {
        {0, VARTYPE_U16, 0, 255, 5, 0, "B button item", .method = Equips_ModifyButton},
        {0, VARTYPE_U16, 0, 255, 5, 0, "Y button item", .method = Equips_ModifyButton},
        {0, VARTYPE_U16, 0, 255, 5, 0, "X button item", .method = Equips_ModifyButton},
        {0, VARTYPE_U16, 0, 255, 5, 0, "I button item", .method = Equips_ModifyButton},
        {0, VARTYPE_U16, 0, 255, 5, 0, "II button item", .method = Equips_ModifyButton},
        {0, VARTYPE_U16, 0, 255, 5, 0, "Y button slot", .method = Equips_ModifyButton},
        {0, VARTYPE_U16, 0, 255, 5, 0, "X button slot", .method = Equips_ModifyButton},
        {0, VARTYPE_U16, 0, 255, 5, 0, "I button slot", .method = Equips_ModifyButton},
        {0, VARTYPE_U16, 0, 255, 5, 0, "II button slot", .method = Equips_ModifyButton},
        {0, VARTYPE_U16, 0,   3, 5, 0, "Sword (0-3) - Swordless Flag OFF", .method = Equips_ModifyGear},
        {0, VARTYPE_U16, 0,   3, 5, 0, "Shield (0-3)", .method = Equips_ModifyGear},
        {0, VARTYPE_U16, 0,   3, 5, 0, "Tunic (0-3)", .method = Equips_ModifyGear},
        {0, VARTYPE_U16, 0,   3, 5, 0, "Boots (0-3)", .method = Equips_ModifyGear},
        {0, VARTYPE_U16, 0, 255, 5, 0, "Temp B", .method = Equips_ModifyTempB},
    }
};
