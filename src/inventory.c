...
AmountMenu InventoryAmountsMenu = {
    ...
    .initialCursorPos = 0,
    {
        ...
        {.amount = 0, .isSigned = false, .min = 0, .max =   255, .nDigits = 5, .hex = false,
        ...
        {.amount = 0, .isSigned = false, .min = 0, .max =     1, .nDigits = 5, .hex = false,
            .title = "Double Defense (1 for on, 0 for off)", .method = Inventory_AmountsSelect},
        {.amount = 0, .isSigned = false, .min = 0, .max =     2, .nDigits = 5, .hex = false,
        ...
        {.amount = 0, .isSigned = false, .min = 0, .max =  0x7F, .nDigits = 4, .hex = true,
