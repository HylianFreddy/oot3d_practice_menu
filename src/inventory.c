...
AmountMenu InventoryAmountsMenu = {
    ...
    .initialCursorPos = 0,
    {
        {0, VARTYPE_U16, 0,   255, 3, 0, "Deku Sticks", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,   255, 5, 0, "Deku Nuts", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,   255, 5, 0, "Bombs", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,   255, 5, 0, "Arrows", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,   255, 5, 0, "Deku Seeds", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,   255, 5, 0, "Bombchus", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,   255, 5, 0, "Magic Beans", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,     0, 5, 0, "Rupees", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,     0, 5, 0, "Giant's Knife hits remaining", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,     1, 5, 0, "Double Defense (1 for on, 0 for off)", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,     2, 5, 0, "Magic meter size (1 = normal, 2 = double)", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,   0x0, 4, 1, "Heart Containers (0x10 per container)", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0, 0x140, 4, 1, "Current Health (0x10 per container)", .method = Inventory_AmountsSelect},
        {0, VARTYPE_U16, 0,  0x7F, 4, 1, "Current Magic (0x30 for normal, 0x60 for double)", .method = Inventory_AmountsSelect},
    }
};
