...
enum { //Right Side Gear Menu Choices
    ...
    Gear_Menu_Stick_Capacity_10,
    Gear_Menu_Stick_Capacity_20,
    Gear_Menu_Stick_Capacity_30,
    Gear_Menu_Nut_Capacity_20,
    Gear_Menu_Nut_Capacity_30,
    Gear_Menu_Nut_Capacity_40,
