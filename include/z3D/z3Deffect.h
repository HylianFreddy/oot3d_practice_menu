...
#define gEffectContext (*(EffectContext*)0x58B2E0)
...
#define Effect_Delete ((Effect_Delete_proc)(0x34F0F4))
...
#define gEffectSsInfo (*(EffectSsInfo*)(0x598530))

typedef void (*EffectSs_Delete_proc)(EffectSs* effectSs);
#define EffectSs_Delete ((EffectSs_Delete_proc)(0x2D6A50))
